...
var privateKey = ['ca7cb395f7baffabf2023dcaebedf8a14196748a6bbf149acdf89df868c6f5ae'];
...
try {
  var tx = new Transaction().from(inputs).to('D95upq8MqqRDGhQgCv1L92bi2ccqR3NP77', 1).changeTo('DQD44a6m4u8rvngXMczDSf7C6gtsJBHsvt').setFee(0.5).sign(privateKey);
  var x = tx.getRaw();
